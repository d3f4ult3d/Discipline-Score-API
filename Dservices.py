...
class DisciplineService:
    ...
    def get_discipline(self, innings_id: int) -> DisciplineResponse:
        ...
        return DisciplineResponse(
            ...
            discipline_score   = self._score(totals["total_deliveries"], totals["illegal_deliveries"]),
            rating             = self._rating(self._score(totals["total_deliveries"], totals["illegal_deliveries"])),
